...
def most_pop_articles(SQL_query_1):
        """Query and print results from the view created for most popular articles
	"""
...
def most_pop_authors(SQL_query_2):
        """Query and print the results of popular authors view created for most popular\
        authors of all time"""
...
def percent_error(SQL_query_3):
        """Query and print results from percent errors view for days on which more than 1%\
